...
show_help() {
    ...
    echo -e "  ${BOLD}status${NC}              Show development environment status"
    echo -e "  ${BOLD}urls${NC}                Show all access URLs"
    echo -e "  ${BOLD}test${NC}                Test connectivity to all services"
    echo -e "  ${BOLD}config${NC}              Test Prosody configuration"
    echo -e "  ${BOLD}users${NC}               List all XMPP users"
    echo -e "  ${BOLD}adduser${NC} <username> [password]   Create new XMPP user"
    echo -e "  ${BOLD}deluser${NC} <username>  Delete XMPP user"
    echo -e "  ${BOLD}passwd${NC} <username>   Change user password"
    echo -e "  ${BOLD}logs${NC} [service] [lines]  Show logs (default: all services, 50 lines)"
    echo -e "  ${BOLD}restart${NC} [service]   Restart service (default: prosody)"
    echo -e "  ${BOLD}cleanup${NC}             Clean up development environment"
    echo -e "  ${BOLD}backup${NC}              Backup development data"
    echo -e "  ${BOLD}perf${NC}                Run performance test"
