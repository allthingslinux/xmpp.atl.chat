...
VirtualHost domain
ssl = {
	key = Lua.os.getenv("PROSODY_SSL_KEY") or ("certs/live/" .. domain .. "/privkey.pem"),
	certificate = Lua.os.getenv("PROSODY_SSL_CERT") or ("certs/live/" .. domain .. "/fullchain.pem"),
}
...
name = "upload." .. domain
http_external_url = Lua.os.getenv("PROSODY_UPLOAD_EXTERNAL_URL") or ("https://upload." .. domain .. "/")
